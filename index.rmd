...
barplot(summ$pts, names.arg = summ$team, cex.names = 0.80, main ="Pts & Rank")
```
...
library(data.table)
barplot(summ$pts_h, names.arg = summ$team, cex.names = 0.80, main = "Handicap Pts & Rank")
```
...
DT::datatable(summ2[order(pts_h, decreasing = T),.(users, pts_h, pts, existing_handicap=handicap, new_handicap = round(handicap+additional_handicap,0))])
```
